  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`${data.Title} | ${data.Abstract}`} />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://codenexus.tech/" />
        <meta
          property="og:title"
          content={`${data.Title} | CodeNexus by Arès GNIMAGNON`}
        />
        <meta property="og:description" content={data.Abstract} />
        <meta
          property="og:image"
          content={`https://raw.githubusercontent.com/aresgnimagnon/CodeNexus/main/public${data.HeaderImage}`}
        />
